  ...
  return (
    <div className="relative min-h-svh flex flex-col">
      <section className="container min-h-svh mx-auto px-4 md:px-6 lg:px-8 py-12 md:py-24 md:pt-0 grid lg:grid-cols-2 gap-10 md:gap-12 items-center">
        <div className="space-y-8 text-center lg:text-left">
          ...
          <div className="landing-intro landing-intro-delay-5 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <Button
              ...
              variant={"default"}
              size={"lg"}
              className="w-full sm:w-auto px-8 py-6 rounded-full font-semibold transition-all shadow-lg hover:shadow-primary/25 active:scale-95"
            >
              <a
            ...
            <Button
              ...
              size={"lg"}
              variant={"outline"}
              className="w-full sm:w-auto border border-border px-8 py-6 rounded-full font-semibold transition-all shadow-lg hover:shadow-primary/35 active:scale-95"
            >
              <Link href="/menu">Ver Menús y Paquetes</Link>
            </Button>
          </div>

          <div className="landing-intro landing-intro-delay-6 pt-4 flex items-center justify-center lg:justify-start text-sm text-muted-foreground">
        ...
        <div className="landing-intro landing-intro-delay-4 relative w-full max-w-[420px] sm:max-w-[500px] mx-auto lg:max-w-none">
